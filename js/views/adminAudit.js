...
import { getAuditLog, getAllProfiles, getPeriods, getKaizenByIds, getAvatarSignedUrl } from '../api.js?v=20260911z9';
import { t, tf, getLang } from '../i18n.js?v=20260911z9';
import { escapeHtml, translateError, pageHeader, skeletonRows, stateCard, emptyState, initials, hydrateAvatars } from '../ui.js?v=20260911z9';
import { KAIZEN_STATUS_LABELS } from '../constants.js?v=20260911z9';
