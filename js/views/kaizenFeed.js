...
import { getFeedPage, getPeriods, getMasterData, getAttachmentSignedUrl, getAvatarSignedUrl, getLikesForKaizenIds, likeKaizen, unlikeKaizen } from '../api.js?v=20260911z15';
import { t, tf } from '../i18n.js?v=20260911z15';
import { getQuery, navigate } from '../router.js?v=20260911z15';
import { escapeHtml, translateError, pageHeader, skeletonRows, stateCard, emptyState, thaiDate, initials, openLightbox, hydrateAvatars, masterLabel } from '../ui.js?v=20260911z15';
