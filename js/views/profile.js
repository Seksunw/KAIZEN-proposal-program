...
import { getMyKaizenList, getPeriods, getResults, getMasterData, uploadAvatar, updateProfile, getAvatarSignedUrl, signOut } from '../api.js?v=20260911z9';
import { t, tf, getLang, setLang } from '../i18n.js?v=20260911z9';
import { escapeHtml, translateError, pageHeader, skeletonRows, stateCard, initials, roleLabel, hydrateAvatars, resizeImage, masterLabel } from '../ui.js?v=20260911z9';
